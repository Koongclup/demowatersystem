<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm no-print">
    <div class="container">
        <a class="navbar-brand fw-bold" href="userDashboard.php?page=หน้าหลักรายการ"> Water Management</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-md-auto gap-2">
                <li class="nav-item rounded">
                    <a class="nav-link active" aria-current="page" href="userDashboard.php?page=หน้าหลักรายการ"><i class="bi bi-house-fill me-2"></i>หน้าหลัก</a>
                </li>
                <!--
